...
public class Warp {
	...
	try {
	    ...
	    WarpGate.log.info("Could not write to gates.db!");
	}
    }

    public static void add(String name, int x, int y, int z, float rot, String link, int cost) {
	gates.add(name + "," + x + "," + y + "," + z + ","+ rot +"," + link + "," + cost + ",");
	save();
    }
    ...
    public static void replace(int index, String name, int x, int y, int z, float rot, String link, int cost) {
	gates.remove(index);
	gates.add(name + "," + x + "," + y + "," + z + ","+ rot +"," + link + "," + cost + ",");
	save();
    }
    ...
    public static int getCost(String gate) {
	if(parse(gate).length < 7) {
	    return -1;
	}

	return Integer.valueOf(parse(gate)[6]);
    }
